        ...
        ZStack{
            ZStack{
                BlobOne()
                    .foregroundStyle(
                        LinearGradient(
                            gradient: Gradient(colors: [Color("muniblue"), .white, .pink]),
            ...
            BlobTwo()
                .foregroundStyle(
                    LinearGradient(
                        gradient: Gradient(colors: [Color("muniredone"), .red, .orange]),
                        startPoint: .topLeading,
                        endPoint: .bottomTrailing)
                )
                .frame(width: 300, height: 300)
            ...
            BlobOne()
                .foregroundStyle(
                    LinearGradient(
                        gradient: Gradient(colors: [Color("munigreen"), .blue, .pink]),
                        startPoint: .topLeading,
                        endPoint: .bottomTrailing)
                )
